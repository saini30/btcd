...
var MainNetParams = Params{
	...
	TargetTimespan:           time.Hour * 24 * 7, // 14 days
	...
	// Checkpoints ordered from oldest to newest.
	Checkpoints: []Checkpoint{
		{2016, newHashFromStr("00000b2661514e0bcb1e826a7e8bfb314137e1b195b0e4d2c5cb494bb7443a67")},
		{4032, newHashFromStr("00000fbbfeb737ca9b9292ad453574e199a6fa306949ff136b54bb4a3a89587b")},
	...
	RuleChangeActivationThreshold: 9560, // 95% of MinerConfirmationWindow
	MinerConfirmationWindow:       10080, //
	Deployments: [DefinedDeployments]ConsensusDeployment{
		DeploymentTestDummy: {
			BitNumber:  28,
			StartTime:  1655767977, // January 1, 2008 UTC
			ExpireTime: 1684625577, // December 31, 2008 UTC
		},
		DeploymentCSV: {
			BitNumber:  0,
	...
	// BIP 173.
	Bech32HRPSegwit: "bro", // always bc for main net

	// Address encoding magics
	PubKeyHashAddrID:        0x35, // starts with 1
	ScriptHashAddrID:        0x55, // starts with 3
...
var RegressionNetParams = Params{
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "bbro", // always bcrt for reg test net

	// Address encoding magics
	PubKeyHashAddrID: 0x78, // starts with m or n
	ScriptHashAddrID: 0x8c, // starts with 2
...
var TestNet3Params = Params{
	...
	// Checkpoints ordered from oldest to newest.
	Checkpoints: []Checkpoint{
		{2016, newHashFromStr("0000075e9046c61f9c837bf16a0f58a59097db6c03233d6f411355dc950e2d7c")},
		{4032, newHashFromStr("0000057500cbb72c59174f0db378d6f27da0a9970abd52b7373bb1cab42a0367")},
	...
	// The miner confirmation window is defined as:
	//   target proof of work timespan / target proof of work spacing
	RuleChangeActivationThreshold: 7560, // 75% of MinerConfirmationWindow
	MinerConfirmationWindow:       10080,
	Deployments: [DefinedDeployments]ConsensusDeployment{
		DeploymentTestDummy: {
			BitNumber:  28,
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "bro1", // always tb for test net
